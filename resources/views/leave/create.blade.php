    ...
    <div class="col-lg-14">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div id="pay-invoice">
                    <div class="card-body">
                        <form action="{{ url('leave') }}" method="post" novalidate="novalidate">
                            @csrf
                            ...
                            <div class="form-group">
                                <label for="status" class="control-label mb-1" hidden>Status</label>
                                <select class="form-control" hidden name="status" aria-label="Default select example">
