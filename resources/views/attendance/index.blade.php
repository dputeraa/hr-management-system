            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <a href="{{ url('attendance/create') }}" class="btn btn-outline-success">
                                ...
                                <tbody>
                                    @foreach ($attendances as $attendance)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $attendance->employee->position->name_position }}</td>
                                            <td>{{ $attendance->employee->position->departement->name_departement }}</td>
                                            <td>{{ \Carbon\Carbon::parse($attendance->attendance_date)->format('l, d F Y') }}
                                            </td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ url("attendance/$attendance->id/delete") }}"
